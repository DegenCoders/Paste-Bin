package com.degenCoders.pastebin.config;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests((request) -> request.requestMatchers(HttpMethod.OPTIONS).permitAll()
                        ...
                        .requestMatchers("/api/notes/create").permitAll()
                        ...
                        .requestMatchers("/api/users/notes").hasAuthority(RoleEntity.USER.name())
                        .requestMatchers("/api/users/dashboard").hasAuthority(RoleEntity.USER.name())
